    ...
    internal class Card {
        ...
        public void Draw(SpriteBatch spritebatch) {
            ...
            if (isFaceUp) {
                ...
                string strType = "CardType" + (iTypeID + 1).ToString().PadLeft(2, '0');
                spritebatch.Draw(Game1.textures[strType], new Rectangle((int)position.X, (int)position.Y, CARD_WIDTH, CARD_HEIGHT), colorSymbol);
            }
        }
        ...
        public bool checkPress(int in_x, int in_y) {
            ...
            if (!isFaceUp && rect1.Contains(in_x, in_y)) {
                isFaceUp = true;
                isPressed = true;
                Game1.soundeffects["CardFlip"].Play();
