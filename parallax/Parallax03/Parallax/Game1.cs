...
namespace Parallax {
    public class Game1 : Game {
        ...
        protected override void Draw(GameTime gameTime) {
            ...
            float fParallaxMountains = 0.1f;
            float fParallaxTrees = 1.0f;
            float fParallaxBricks = 1.0f;
            ...
            for (i = -10; i < 10; i++) {
                ...
                int x = i * 256;
                int y = 6 * 64;
                _spriteBatch.Draw(sprites["mountain"], new Rectangle(x - (int)(posCamera.X * fParallaxMountains), y, 256, 256), Color.White);
            }
            ...
            for (i = -40; i < 40; i++) {
                for (j = 8; j < 9; j++) {
                    int x = i * 64;
                    int y = j * 64;
                    _spriteBatch.Draw(sprites["tree"], new Rectangle(x - (int) (posCamera.X * fParallaxTrees), y, 64, 128), Color.White);
                }
            }
            ...
            for (i = -40; i < 40; i++) {
                for (j = 10; j < 12; j++) {
                    int x = i * 64;
                    int y = j * 64;
                    _spriteBatch.Draw(sprites["brick"], new Rectangle( x - (int) (posCamera.X * fParallaxBricks), y, 64, 64), Color.White);
                }
            }
