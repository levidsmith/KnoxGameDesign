        ...
        public override void Draw(GameTime gameTime, SpriteBatch _spriteBatch, Dictionary<string, SpriteFont> fonts, Dictionary<string, Texture2D> sprites) {
            ...
            for (i = 0; i < gamemanager.spaces.Count; i++) {
                ...
                if (gamemanager.spaces[i] is SpaceArrested) {
                    ...
                    _spriteBatch.DrawString(fonts["fontNormal"], spaceeventcard.getName(), gamemanager.spaces[i].position + new Vector2(48, 0), Color.Black);
                } else if (gamemanager.spaces[i] is SpaceStart) {
                    SpaceStart spacestart = (SpaceStart)gamemanager.spaces[i];
                    _spriteBatch.DrawString(fonts["fontNormal"], spacestart.strName, gamemanager.spaces[i].position + new Vector2(48, 0), Color.Black);
                } else if (gamemanager.spaces[i] is SpaceFree) {
                    SpaceFree spacefree = (SpaceFree)gamemanager.spaces[i];
                    _spriteBatch.DrawString(fonts["fontNormal"], spacefree.strName, gamemanager.spaces[i].position + new Vector2(48, 0), Color.Black);
                } else if (gamemanager.spaces[i] is SpaceTaxes) {
                    SpaceTaxes spacetaxes = (SpaceTaxes)gamemanager.spaces[i];
                    _spriteBatch.DrawString(fonts["fontNormal"], spacetaxes.strName, gamemanager.spaces[i].position + new Vector2(48, 0), Color.Black);
            ...
            for (i = 0; i < gamemanager.players.Count; i++) {
                ...
                _spriteBatch.DrawString(fonts["fontNormal"], "" + gamemanager.players[i].iGetOutFreeCards, vectPosition + new Vector2(300, 0), Color.Black);
            }
