    ...
    public class GameManager {
        ...
        public void mortgageSelectPrevious() {
            ...
            if (iMortgageSelect < 0) {
                iMortgageSelect = playerCurrent.properties.Count - 1;
            }
        ...
        public void mortgageSelectNext() {
            iMortgageSelect++;
            if (iMortgageSelect >= playerCurrent.properties.Count) {
                iMortgageSelect = 0;
            }
        }

        public void mortgageSelectMortgage() {
            if (!playerCurrent.properties[iMortgageSelect].isMortgaged) {
                playerCurrent.iMoney += playerCurrent.properties[iMortgageSelect].iPurchasePrice / 2;
                playerCurrent.properties[iMortgageSelect].isMortgaged = true;
            }
        ...
        public void mortgageSelectUnmortgage() {
            if (playerCurrent.properties[iMortgageSelect].isMortgaged) {
                playerCurrent.iMoney -= (int)((playerCurrent.properties[iMortgageSelect].iPurchasePrice / 2) * 1.1f);
                playerCurrent.properties[iMortgageSelect].isMortgaged = false;
            }
