        ...
        protected override void Draw(GameTime gameTime) {
                ...
                if (property != null) {
                    ...
                    if (!property.isOwned()) {
                        ...
                        if (property.isMortgaged) {
                            _spriteBatch.DrawString(fontSmall, "Mortgaged", gamemanager.spaces[i].position + new Vector2(48, 32), Color.Black);
            ...
            switch(gamemanager.gamestate) {
                ...
                case GameManager.GameState.LandOnSpace:
                    ...
                    _spriteBatch.DrawString(fontNormal, "M: Mortgage", new Vector2(32, 850), Color.Black);
                    _spriteBatch.DrawString(fontNormal, "E: End Turn", new Vector2(32, 900), Color.Black);
                    break;
                case GameManager.GameState.Mortgage:
                    _spriteBatch.DrawString(fontNormal, "M: Mortgage", new Vector2(32, 750), Color.Black);
                    _spriteBatch.DrawString(fontNormal, "U: Unmortgage", new Vector2(32, 800), Color.Black);
                    _spriteBatch.DrawString(fontNormal, "Q: Return", new Vector2(32, 900), Color.Black);

                    _spriteBatch.DrawString(fontSmall, "Select property to mortgage", new Vector2(1200, 700), Color.Black);

                    i = 0;
                    foreach (Property p in gamemanager.playerCurrent.properties) {
                        Color c = Color.Black;
                        if (gamemanager.iMortgageSelect == i) {
                            c = Color.Blue;
                        }
                        if (p.isMortgaged) {
                            _spriteBatch.DrawString(fontSmall, "M", new Vector2(1200, 720 + (i * 20)), c);
                        }
                        _spriteBatch.DrawString(fontSmall, p.strName, new Vector2(1250, 720 + (i * 20)), c);
                        i++;
