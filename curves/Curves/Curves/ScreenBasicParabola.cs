...
namespace Curves {
    class ScreenBasicParabola : Screen {
        ...
        public ScreenBasicParabola(GameManager in_gamemanager) : base(in_gamemanager) {
            fXCurrent = fXMin;
            fSpeed = 4f;
        ...
        public override void Draw(SpriteBatch sb) {
            ...
            sb.DrawString(gamemanager.fonts["largefont"], "Basic Parabola", new Vector2(8, 32 * 0), Color.Red);
