...
namespace P64::Script::C11955FF25B55736
{
  ...
  void update(Object& obj, Data *data, float deltaTime) {
    ...
    if (obj.pos.z < 400.0f) {
      obj.pos.z = 400.0f;
    } else if (obj.pos.z > 700.0f) {
      obj.pos.z = 700.0f;
    }


    if (obj.pos.x < -1000.0f) {
      obj.pos.x = -1000.0f;
    } else if (obj.pos.x > 1000.0f) {
      obj.pos.x = 1000.0f;
    }


    if (joypad.btn.a) {
      P64::Object *objBullet = SceneManager::getCurrent().getObjectById(6);
      objBullet->pos.x = obj.pos.x;
      objBullet->pos.z = obj.pos.z;
    }
