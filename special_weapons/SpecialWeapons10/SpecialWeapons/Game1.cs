...
namespace SpecialWeapons {
    public class Game1 : Game {
        ...
        protected override void Initialize() {
            ...
            listWeapons.Add(new WeaponFreeze());
            listWeapons.Add(new WeaponWave());
            listWeapons.Add(new WeaponBoomerang());
            listWeapons.Add(new WeaponTornado());
            listWeapons.Add(new WeaponCharge());
            listWeapons.Add(new WeaponOrbit());
            listWeapons.Add(new WeaponRoller());
            listWeapons.Add(new WeaponExploder());
            player.weapon = listWeapons[listWeapons.Count - 1];
            player.iCurrentWeapon = listWeapons.Count - 1;
        ...
        private void handleInput(GameTime gameTime) {
            ...
            if (keyboardState.IsKeyDown(Keys.Space) ) {
                player.charge((float)gameTime.ElapsedGameTime.TotalSeconds, this);
            }

            if (!keyboardState.IsKeyDown(Keys.Space) && keyboardStatePrevious.IsKeyDown(Keys.Space)) {

                player.chargeRelease(this);
            }
