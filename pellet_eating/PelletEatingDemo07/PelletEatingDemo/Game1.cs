...
namespace PelletEatingDemo
{
    public class Game1 : Game {
        ...
        public void resetLevel() {
            ...
            e.resetPosition();
            e.direction = Actor.Direction.RIGHT;
            e.color = Color.Red;
            enemies.Add(e);
            ...
            e.yStart = (1 * iCellWidth);
            e.resetPosition();
            e.direction = Actor.Direction.LEFT;
        ...
        protected override void Update(GameTime gameTime) {
            ...
            if (state == State.title) {
                ...
                if (fTitleCountDown > 0f) {
                    ...
                    if (pellets.Count == 0) {
                        transitionStateComplete();
                    }
            } else if (state == State.complete) {
                //                    if (Keyboard.GetState().IsKeyDown(Keys.Space)) {
                if (fCompleteCountDown > 0f) {
                    fCompleteCountDown -= (float)gameTime.ElapsedGameTime.TotalSeconds;
                } else { 
        ...
        public void transitionStateTitle() {
            fTitleCountDown = 0.5f;
            state = State.title;
        }

        public void transitionStateReady() {
            resetActorPositions();
            fReadyCountDown = 0.5f;
            state = State.ready;
        }
