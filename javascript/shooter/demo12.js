...
class Player {
    ...
    draw(ctx) {
        ctx.drawImage(images["ship"], 0, 0, 64, 64, this.x * UNIT_SIZE, this.y * UNIT_SIZE, this.w * UNIT_SIZE, this.h * UNIT_SIZE);
    }
...
class Enemy {
    ...
    draw(ctx) {
        if (this.isAlive) {
            ctx.drawImage(images["enemy"], 0, 0, 64, 64, this.x * UNIT_SIZE, this.y * UNIT_SIZE, this.w * UNIT_SIZE, this.h * UNIT_SIZE);
        }
    }
...
class Bullet {
    ...
    draw(ctx) {
        if (this.isAlive) {
            ctx.drawImage(images["bullet"], 0, 0, 16, 16, this.x * UNIT_SIZE, this.y * UNIT_SIZE, this.w * UNIT_SIZE, this.h * UNIT_SIZE);
        }
    }
...
function startGame() {
    ...
    sounds = [];
    sounds["shoot"] = new Audio("assets/shoot.wav");
