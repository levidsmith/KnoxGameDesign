    ...
    public class Game1 : Game {
        ...
        protected override void Update(GameTime gameTime) {
            ...
            if (state.LeftButton == ButtonState.Pressed && statePrevious.LeftButton == ButtonState.Released) {
                ...
                } else if (iBoard[iSelectedRow, iSelectedCol] == 0 && (iSelectedRow + iSelectedCol) % 2 == 1) { 
                    
                    if (iSelectedPieceRow != -1 && iSelectedPieceCol != -1) {
                        iBoard[iSelectedRow, iSelectedCol] = iBoard[iSelectedPieceRow, iSelectedPieceCol];
                        iBoard[iSelectedPieceRow, iSelectedPieceCol] = 0;
                        iSelectedPieceRow = -1;
                        iSelectedPieceCol = -1;
                    }
